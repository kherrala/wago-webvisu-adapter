export const config = {
  ...
  protocol: {
    ...
    dropdownScrollPollIntervalMs: parseInt(process.env.PROTOCOL_DROPDOWN_SCROLL_POLL_INTERVAL_MS || '120', 10),
    dropdownItemClickYOffset: parseInt(process.env.PROTOCOL_DROPDOWN_ITEM_CLICK_Y_OFFSET || '2', 10),
    scrollSettleDelayMs: parseInt(process.env.PROTOCOL_SCROLL_SETTLE_DELAY_MS || '800', 10),
    ...
    selectionSettleDelayMs: parseInt(process.env.PROTOCOL_SELECTION_SETTLE_DELAY_MS || '220', 10),
    selectionVerifyTimeoutMs: parseInt(process.env.PROTOCOL_SELECTION_VERIFY_TIMEOUT_MS || '2500', 10),
    selectionVerifyPollIntervalMs: parseInt(process.env.PROTOCOL_SELECTION_VERIFY_POLL_INTERVAL_MS || '120', 10),
    maxSelectionAttempts: parseInt(process.env.PROTOCOL_MAX_SELECTION_ATTEMPTS || '3', 10),
    togglePreClickDelayMs: parseInt(process.env.PROTOCOL_TOGGLE_PRE_CLICK_DELAY_MS || '250', 10),
    togglePressHoldMs: parseInt(process.env.PROTOCOL_TOGGLE_PRESS_HOLD_MS || '140', 10),
    togglePostClickDelayMs: parseInt(process.env.PROTOCOL_TOGGLE_POST_CLICK_DELAY_MS || '500', 10),
    togglePostRenderPolls: parseInt(process.env.PROTOCOL_TOGGLE_POST_RENDER_POLLS || '2', 10),
    togglePostRenderPollDelayMs: parseInt(process.env.PROTOCOL_TOGGLE_POST_RENDER_POLL_DELAY_MS || '200', 10),
    statusPollDelayMs: parseInt(process.env.PROTOCOL_STATUS_POLL_DELAY_MS || '200', 10),
    statusMaxAttempts: parseInt(process.env.PROTOCOL_STATUS_MAX_ATTEMPTS || '6', 10),
    reconnectDelay: 5000,
    postClickDelay: 50,
    postSelectDelay: 100,
